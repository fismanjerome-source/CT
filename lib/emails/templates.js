  ...
  return {
    ...
    html: enveloppe(`
      ...
      <div style="background:#F4F5F1; border-radius:6px; padding:16px; margin:16px 0;">
        ...
        <div style="font-size:24px; font-weight:bold; color:#1B3A5C;">${montantProrata.toFixed(2)} €</div>
      </div>
      <p style="color:#1A2420; line-height:1.6;">
        À partir du mois prochain, le tarif plein sera de <strong>30 € par mois</strong>, facturé exactement comme
