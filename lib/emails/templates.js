...
export function emailConfirmationReservation({ clientNom, centreNom, adresse, dateLisible, heure, reference }) {
  return {
    ...
    html: enveloppe(`
      ...
      ${bouton('Consulter ou annuler mon RDV', `${SITE_URL}/suivi`)}
    `),
  };
}

export function emailRappelRendezVous({ clientNom, centreNom, adresse, heure }) {
  return {
