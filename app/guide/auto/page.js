  ...
  return (
    <>
      ...
      <section className="container legal-content" style={{ padding: '32px 24px 64px' }}>
        ...
        <p>
          Pour un véhicule neuf, le premier contrôle doit être réalisé dans les <strong>6 mois précédant le 4ᵉ
          anniversaire</strong> de sa première mise en circulation. Par exemple, un véhicule mis en circulation
          le 1ᵉʳ octobre 2022 doit passer son premier contrôle entre le 1ᵉʳ avril et le 30 septembre 2026.
          Aucune convocation n'est envoyée : c'est à vous de prendre l'initiative.
        </p>

        <h2>À quelle fréquence renouveler le contrôle ?</h2>
        <p>
          Si le résultat est favorable, le contrôle technique est valable <strong>2 ans</strong>. La date limite
          est indiquée par un timbre apposé sur la carte grise. Un contrôle réalisé le 14 mai 2025 avec un
          résultat favorable reste valable jusqu'au 13 mai 2027.
        </p>

        <h2>Les 133 points de contrôle</h2>
        <p>
          Le contrôleur examine <strong>133 points répartis en 9 grandes familles</strong>, définies par arrêté
          ministériel :
        </p>
        <ul>
        ...
        <p className="help-text">
          Depuis le 1ᵉʳ janvier 2026, le contrôle vérifie aussi si le véhicule est concerné par une campagne de
          rappel qualifiée de grave par le constructeur (par exemple les airbags Takata). Si c'est le cas et que
          la réparation n'a pas été faite, le véhicule ne peut plus circuler dès le lendemain du contrôle.
        </p>
        ...
        <p>
          ...
          vous devez faire réparer le véhicule <strong>et repasser une contre-visite dans un délai de 2 mois</strong>
          après le contrôle initial — dans n'importe quel centre agréé, pas nécessairement celui d'origine.
        </p>
        <p>
        ...
        <p>
          ...
          comparer les centres disponibles près de chez vous. Rouler avec un contrôle technique expiré expose à
          une amende pouvant aller jusqu'à 750 €, généralement une amende forfaitaire de 135 €. Les forces de
          l'ordre peuvent aussi immobiliser le véhicule, voire le mettre en fourrière en cas de défaillance non
          réparée.
        </p>
